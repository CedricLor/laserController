...
void myWSReceiver::_requestIFChange(JsonObject& _obj) {
  ...
  /** If this is a save or apply settings message relating to (i) Wifi, (ii) softAP, (iii) mesh, 
   *  (iv) thisControllerBox.globBaseVars.isRoot or (v) thisControllerBox.globBaseVars.hasInterface
   *  parameters.
   * */
