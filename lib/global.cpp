...
// const short I_NODE_NAME = 200;                          // BOX BY BOX
...
const short MESH_REQUEST_CAPACITY = 13;            // Used for sizing of my custom JSONDocuments received and sent via the mesh and is used in MeshViews and MeshController
...
const short I_CONTROLLER_BOX_PREFIX = 200;              // Used to calculate the index of this box in the ControlerBoxes array
const short MY_INDEX_IN_CB_ARRAY = I_NODE_NAME - I_CONTROLLER_BOX_PREFIX;
