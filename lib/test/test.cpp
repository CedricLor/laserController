...
void test::rawTonesStackTonesArray(const char * _methodName, uint16_t _toneIndexNumber) {
  ...
  Serial.printf("%s _tones._tonesArray.at(%u)._laserPinsStatesArr.at(0) shall be 1. Is [%u]\n", _methodName, _toneIndexNumber,
    _tones._tonesArray.at(_toneIndexNumber)._laserPinsStatesArr.at(0));
  Serial.printf("%s _tones._tonesArray.at(%u)._laserPinsStatesArr.at(3) shall be 1. Is [%u]\n", _methodName, _toneIndexNumber,
    _tones._tonesArray.at(_toneIndexNumber)._laserPinsStatesArr.at(3));
    
  Serial.printf("%s _tones._tonesArray.at(%u).i16IndexNumber is [%i]\n", _methodName, _toneIndexNumber,
    _tones._tonesArray.at(_toneIndexNumber).i16IndexNumber);
  Serial.printf("%s _tones._tonesArray.at(%u)._playTone(_laserPins) is [%i]\n", _methodName, _toneIndexNumber,
    _tones._tonesArray.at(_toneIndexNumber)._playTone(_laserPins));
  Serial.printf("%s ( _tones._tonesArray.at(%u).i16IndexNumber == _tones._tonesArray.at(%u)._playTone(_laserPins)) shall be 1. Is [%i]\n", _methodName, _toneIndexNumber, _toneIndexNumber,
    _tones._tonesArray.at(_toneIndexNumber).i16IndexNumber == _tones._tonesArray.at(_toneIndexNumber)._playTone(_laserPins));
  Serial.printf("%s _tones._playTone(%u) shall be [%i]\n", _methodName, _toneIndexNumber,
    _tones._playTone(_toneIndexNumber));
  Serial.printf("%s (_tones._tonesArray.at(%u)._playTone(_laserPins)) == _tones._playTone(%u) shall be 1. Is [%i]\n\n", _methodName, _toneIndexNumber, _toneIndexNumber,
    _tones._tonesArray.at(_toneIndexNumber)._playTone(_laserPins) == _tones._playTone(_toneIndexNumber));
}
...
void test::noteStackParamConstructor(const char * _methodName) {
  ...
  note _note{1, 1};
  tone _tone(tones{}._tonesArray.at(3));
  ...
  Serial.printf("%s note::globalTones._tonesArray.at(_note.getToneNumber()).i16IndexNumber shall be 1. Is [%i]\n", _methodName, 
    note::globalTones._tonesArray.at(_note.getToneNumber()).i16IndexNumber);
  Serial.printf("%s calling _note._setTone(_tone) with _tone(tones{}._tonesArray.at(3)).\n", _methodName);
  Serial.printf("%s _note._setTone(_tone) shall be 3. Is [%i]\n", _methodName, 
    _note._setTone(_tone));
  Serial.printf("%s note::globalTones._tonesArray.at(_note.getToneNumber()).i16IndexNumber shall be 3. Is [%i]\n", _methodName, 
    note::globalTones._tonesArray.at(_note.getToneNumber()).i16IndexNumber);
...
void test::noteStackDefaultConstructor(const char * _methodName) {
  ...
  note _noteDef;
  tone _tone2(tones{}._tonesArray.at(2));
  ...
  Serial.printf("%s note::globalTones._tonesArray.at(_noteDef.getToneNumber()).i16IndexNumber shall be 0. Is [%i]\n", _methodName, 
    note::globalTones._tonesArray.at(_noteDef.getToneNumber()).i16IndexNumber);
  Serial.printf("%s calling _noteDef._setTone(_tone2) with _tone2(tones{}._tonesArray.at(2)).\n", _methodName);
  Serial.printf("%s _noteDef._setTone(_tone2) shall be 2. Is [%i]\n", _methodName, 
    _noteDef._setTone(_tone2));
  Serial.printf("%s note::globalTones._tonesArray.at(_noteDef.getToneNumber()).i16IndexNumber shall be 2. Is [%i]\n", _methodName, 
    note::globalTones._tonesArray.at(_noteDef.getToneNumber()).i16IndexNumber);
...
void test::noteStackStraightCopyConstructor(const char * _methodName) {
  ...
  Serial.printf("%s note::globalTones._tonesArray.at(note{1,1}.getToneNumber()).i16IndexNumber shall be 1. Is [%i]\n", _methodName, 
    note::globalTones._tonesArray.at(note{1,1}.getToneNumber()).i16IndexNumber);

  Serial.printf("%s calling note{1,1}._setTone(_tone2) with _tone2(tones{}._tonesArray.at(2)).\n", _methodName);
  tone _tone2(tones{}._tonesArray.at(2));
...
void test::noteStackCopyConstructorInitList(const char * _methodName) {
  ...
  Serial.printf("%s note::globalTones._tonesArray.at(_noteCpy.getToneNumber()).i16IndexNumber shall be 3. Is [%i]\n", _methodName, 
    note::globalTones._tonesArray.at(_noteCpy.getToneNumber()).i16IndexNumber);

  Serial.printf("%s calling _noteCpy._setTone(_tone2) with _tone(tones{}._tonesArray.at(2)).\n", _methodName);
  Serial.printf("%s _noteCpy._setTone(_tone2) shall be 2. Is [%i]\n", _methodName, 
    _noteCpy._setTone(_tone2));
  Serial.printf("%s note::globalTones._tonesArray.at(_noteCpy.getToneNumber()).i16IndexNumber shall be 2. Is [%i]\n", _methodName, 
    note::globalTones._tonesArray.at(_noteCpy.getToneNumber()).i16IndexNumber);
...
void test::noteStackCopyConstructorEqualSign(const char * _methodName) {
  ...
  Serial.printf("%s note::globalTones._tonesArray.at(_noteCpy2.getToneNumber()).i16IndexNumber shall be 3. Is [%i]\n", _methodName, 
    note::globalTones._tonesArray.at(_noteCpy2.getToneNumber()).i16IndexNumber);

  Serial.printf("%s calling _noteCpy2._setTone(_tone2) with _tone(tones{}._tonesArray.at(2)).\n", _methodName);
  Serial.printf("%s _noteCpy2._setTone(_tone2) shall be 2. Is [%i]\n", _methodName, 
    _noteCpy2._setTone(_tone2));
  Serial.printf("%s note::globalTones._tonesArray.at(_noteCpy2.getToneNumber()).i16IndexNumber shall be 2. Is [%i]\n", _methodName, 
    note::globalTones._tonesArray.at(_noteCpy2.getToneNumber()).i16IndexNumber);
...
void test::noteStackCopyAssignmentOp(const char * _methodName) {
  ...
  Serial.printf("%s note::globalTones._tonesArray.at(_note2.getToneNumber()).i16IndexNumber shall be 3. Is [%i]\n", _methodName, 
    note::globalTones._tonesArray.at(_note2.getToneNumber()).i16IndexNumber);
    
  Serial.printf("%s calling _note2._setTone(_tone2) with _tone(tones{}._tonesArray.at(2)).\n", _methodName);
  Serial.printf("%s _note2._setTone(_tone2) shall be 2. Is [%i]\n", _methodName, 
    _note2._setTone(_tone2));
  Serial.printf("%s note::globalTones._tonesArray.at(_note2.getToneNumber()).i16IndexNumber shall be 2. Is [%i]\n", _methodName, 
    note::globalTones._tonesArray.at(_note2.getToneNumber()).i16IndexNumber);
...
void test::noteStackCopyConstructorAndCopyAssignment(const char * _methodName) {
  ...
  Serial.printf("%s note::globalTones._tonesArray.at(_note4.getToneNumber()).i16IndexNumber shall be 1. Is [%i]\n", _methodName, 
    note::globalTones._tonesArray.at(_note4.getToneNumber()).i16IndexNumber);

  Serial.printf("%s calling _note4._setTone(_tone2) with _tone(tones{}._tonesArray.at(2)).\n", _methodName);
  Serial.printf("%s _note4._setTone(_tone2) shall be 1. Is [%i]\n", _methodName, 
    _note4._setTone(_tone2));
  Serial.printf("%s note::globalTones._tonesArray.at(_note4.getToneNumber()).i16IndexNumber shall be 2. Is [%i]\n", _methodName, 
    note::globalTones._tonesArray.at(_note4.getToneNumber()).i16IndexNumber);
...
void test::notesArrayStackToneSelection(const char * _methodName) {
  ...
  Serial.printf("%s note::globalTones._tonesArray.at(_emptyNotesArray.at(0).getToneNumber()).i16IndexNumber shall be 0. Is [%i]\n", _methodName, 
    note::globalTones._tonesArray.at(_emptyNotesArray.at(0).getToneNumber()).i16IndexNumber);
  Serial.printf("%s note::globalTones._tonesArray.at(_emptyNotesArray.at(15).getToneNumber()).i16IndexNumber shall be 0. Is [%i]\n", _methodName, 
    note::globalTones._tonesArray.at(_emptyNotesArray.at(15).getToneNumber()).i16IndexNumber);
  Serial.printf("%s note::globalTones._tonesArray.at(_emptyNotesArray.at(0).getToneNumber())._laserPinsStatesArr.at(0) shall be 1. Is [%i]\n", _methodName, 
    note::globalTones._tonesArray.at(_emptyNotesArray.at(0).getToneNumber())._laserPinsStatesArr.at(0));
  Serial.printf("%s note::globalTones._tonesArray.at(_emptyNotesArray.at(15).getToneNumber())._laserPinsStatesArr.at(3) shall be 1. Is [%i]\n", _methodName, 
    note::globalTones._tonesArray.at(_emptyNotesArray.at(15).getToneNumber())._laserPinsStatesArr.at(3));
}
...
void test::rawNotesStackDefaultMembers(const char * _methodName, notes & _notes) {
  ...
  Serial.printf("%s _notes._tones._tonesArray.at(0)._laserPinsStatesArr.at(0) shall be 1. Is [%u]\n", _methodName, 
    _notes._tones._tonesArray.at(0)._laserPinsStatesArr.at(0));
  Serial.printf("%s _notes._tones._tonesArray.at(0)._laserPinsStatesArr.at(3) shall be 1. Is [%u]\n", _methodName, 
    _notes._tones._tonesArray.at(0)._laserPinsStatesArr.at(3));
  Serial.printf("%s _notes._tones._tonesArray.at(15)._laserPinsStatesArr.at(0) shall be 0. Is [%u]\n", _methodName, 
    _notes._tones._tonesArray.at(15)._laserPinsStatesArr.at(0));
  Serial.printf("%s _notes._tones._tonesArray.at(15)._laserPinsStatesArr.at(3) shall be 0. Is [%u]\n\n", _methodName, 
    _notes._tones._tonesArray.at(15)._laserPinsStatesArr.at(3));
}
...
void test::rawNotesStackDefaultPlayTone(const char * _methodName, laserPins & _laserPins, notes & _notes) {
  // _notes->_playTone
  Serial.printf("%s _notes._tones._tonesArray.at(0)._playTone(_laserPins) shall be 0. Is [%i]\n", _methodName, 
    _notes._tones._tonesArray.at(0)._playTone(_laserPins));
  Serial.printf("%s _notes._tones._tonesArray.at(15)._playTone(_laserPins) shall be 15. Is [%i]\n\n", _methodName, 
    _notes._tones._tonesArray.at(15)._playTone(_laserPins));
}
